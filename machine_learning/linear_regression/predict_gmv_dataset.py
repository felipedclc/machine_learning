...
df.drop("COUNT_ACTIVE_USERS", axis=1, inplace=True)

df["COUNT_OFFLINE_REQS"].fillna(df["COUNT_OFFLINE_REQS"].mean(), inplace=True)
df["FLIGHT_CONVERSION_RATE"].fillna(
    df["FLIGHT_CONVERSION_RATE"].mean(), inplace=True
)
df["FLIGHT_CONVERSION_RATE"].fillna(
    df["FLIGHT_CONVERSION_RATE"].mean(), inplace=True
)
# df["COUNT_ACTIVE_USERS"].fillna(df["COUNT_ACTIVE_USERS"].mean(), inplace=True)
...
# x2 = df_2023.drop("TOTAL_AMOUNT", axis=1)
